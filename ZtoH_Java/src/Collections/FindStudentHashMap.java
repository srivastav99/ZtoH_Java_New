...
Country India contains two states - TS, AP
TS is state-1 and it contains 2 district(1.Medchal, 2.Medak)
AP is state-1 and it contains 2 districts(1.Visakhapatnam, 2.Prakasam)
Medchal contains two schools(1.Indian Batting school, 2.Indian Bowling school)
Medak contains two schools(1.Indian All rounders school, 2.Indian WK school)
Visakhapatnam contains two schools(1.Foreign Batting school, 2.Foreign Bowling school)
Prakasam contains two schools(1.Foreign All rounders school, 2.Foreign WK school)
Total of 8 schools in the particular order as mentioned above.
...
public class FindStudentHashMap {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter roll.no to find student details:");
		int r = sc.nextInt();
		...
		st1d1sc1c1.putIfAbsent(1, sc1c1s1); // Storing student name with roll.no into the HashMap .
		...
		st1d1sc1.put("First Standard", st1d1sc1c1);
		...
		st1d1sc1.putIfAbsent("Second Standard", st1d1sc1c2); 
		...
		Map<String, Map<Integer, StudentData>> st1d1sc2 = new HashMap<String, Map<Integer, StudentData>>();
		st1d1sc2.put("First Standard", st1d1sc2c1);
		...
		st1d1sc2.putIfAbsent("Second Standard", st1d1sc2c2); 
		...
		st1d2sc3c1.putIfAbsent(17, sc3c1s1); // Storing student name with roll.no into the HashMap.
		...
		Map<String, Map<Integer, StudentData>> st1d2sc3 = new HashMap<String, Map<Integer, StudentData>>();

		st1d2sc3.put("First Standard", st1d2sc3c1);
		...
		st1d2sc3.putIfAbsent("Second Standard", st1d2sc3c2); 
		...
		st1d2sc4c1.putIfAbsent(25, sc4c1s1); // Storing student name with roll.no into the HashMap.
		...
		Map<String, Map<Integer, StudentData>> st1d2sc4 = new HashMap<String, Map<Integer, StudentData>>();
		st1d2sc4.put("First Standard", st1d2sc4c1);
		...
		st1d2sc4.putIfAbsent("Second Standard", st1d2sc4c2); 
		...
		st2d1sc5c1.putIfAbsent(33, sc5c1s1); // Storing student name with roll.no into the HashMap.
		...
		Map<String, Map<Integer, StudentData>> st2d1sc5 = new HashMap<String, Map<Integer, StudentData>>();

		st2d1sc5.put("First Standard", st2d1sc5c1);
		...
		st2d1sc5.putIfAbsent("Second Standard", st2d1sc5c2); 
		...
		st2d1sc6c1.putIfAbsent(41, sc6c1s1); // Storing student name with roll.no into the HashMap.
		...
		Map<String, Map<Integer, StudentData>> st2d1sc6 = new HashMap<String, Map<Integer, StudentData>>();
		st2d1sc6.put("First Standard", st2d1sc6c1);
		...
		st2d1sc6.putIfAbsent("Second Standard", st2d1sc6c2); 
		...
		st2d2sc7c1.putIfAbsent(49, sc7c1s1); // Storing student name with roll.no into the HashMap.
		...
		Map<String, Map<Integer, StudentData>> st2d2sc7 = new HashMap<String, Map<Integer, StudentData>>();

		st2d2sc7.put("First Standard", st2d2sc7c1);
		...
		st2d2sc7.putIfAbsent("Second Standard", st2d2sc7c2); 
		...
		st2d2sc8c1.putIfAbsent(57, sc8c1s1); // Storing student name with roll.no into the HashMap.
		...
		Map<String, Map<Integer, StudentData>> st2d2sc8 = new HashMap<String, Map<Integer, StudentData>>();

		st2d2sc8.put("First Standard", st2d2sc8c1);
		...
		st2d2sc8.putIfAbsent("Second Standard", st2d2sc8c2); 
						...
						for (String schoolName : st1d1.keySet()) {
							if (schoolName == "Indian Batting school") { // school1
								...
								for (String className : st1d1sc1.keySet()) {
									...
									if (className == "Second Standard") { // class 2
